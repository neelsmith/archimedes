...
# ╔═╡ ac5526aa-a9c7-4ac0-9ed2-c49862cf1a56
(archfolio, euchfolio, imgbase) = split("50r|38r2|038r_035v_Arch50r_Sinar_", "|")

# ╔═╡ 962346da-ad48-46e4-82b7-888b3075f1a7
imgcoll = "urn:cite2:citeap:palimpsest.v1:"

# ╔═╡ 2a2dc1a7-ed01-48c6-92da-b4f6ff73263f
imglist = [
	"urn:cite2:citeap:palimpsest.v1:038r_035v_Arch50r_Sinar_@0.1005,0.7337,0.3224,0.07794",
	"urn:cite2:citeap:palimpsest.v1:038r_035v_Arch50r_Sinar_@0.4434,0.1070,0.3355,0.7044"

]

# ╔═╡ e93d7824-537e-4f19-bcf0-d311446d6efb
md"""# Read the Archimedes Palimpsest"""
...
# ╔═╡ 5e496e25-af9d-4a22-b3b4-ea0c72b5834b
imgid = replace(imgbase, "Sinar_" => "Sinar_$(imgstyle)")

# ╔═╡ caa368ad-f55d-4b2a-8392-b10f2d631872
imgurn = string(imgcoll, imgid) |> Cite2Urn

# ╔═╡ 4e78a54d-6e61-4671-8d74-991fcbfddde8
imgurnlist = map(imglist) do i
	imgid = replace(i, "Sinar_" => "Sinar_$(imgstyle)")
	string(imgid)  |> Cite2Urn
end

# ╔═╡ e9620adf-0271-421f-aed2-a15d49b175d6
mdimgs = map(imgurnlist) do u
